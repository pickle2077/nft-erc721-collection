...
export const emeraldTestnet: NetworkConfigInterface = {
  chainId: 42261,
  symbol: "ROSE",
  blockExplorer: {
    name: "Emerald Explorer (testnet)",
    generateContractUrl: (contractAddress: string) =>
      `https://testnet.explorer.emerald.oasis.dev/address/${contractAddress}`,
    generateTransactionUrl: (transactionAddress: string) =>
      `https://testnet.explorer.emerald.oasis.dev/tx/${transactionAddress}`,
  },
};

export const emeraldMainnet: NetworkConfigInterface = {
  chainId: 42262,
  symbol: "ROSE",
  blockExplorer: {
    name: "Polygonscan",
    generateContractUrl: (contractAddress: string) =>
      `https://explorer.emerald.oasis.dev/address/${contractAddress}`,
    generateTransactionUrl: (transactionAddress: string) =>
      `https://explorer.emerald.oasis.dev/tx/${transactionAddress}`,
  },
};
